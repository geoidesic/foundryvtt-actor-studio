...
function create_each_block(ctx) {
  ...
  return {
    c() {
      ...
      ctx[29].icon)) attr(img, "src", img_src_value);
    ...
    p(ctx2, dirty) {
      ...
      ctx2[29].title + "")) set_data(t_1, t_1_value);
      if (!current || dirty[0] & /*advancementArray*/
      ...
      if (dirty[0] & /*advancementComponents, advancementArray*/
      1152 && switch_value !== (switch_value = /*advancementComponents*/
      ctx2[7][
        /*advancement*/
        ctx2[29].type
      ])) {
...
function instance($$self, $$props, $$invalidate) {
  ...
  component_subscribe($$self, actor, (value2) => $$invalidate(20, $actor = value2));
  ...
  async function importAdvancements(advancements) {
    ...
    for (const advancement of advancements) {
      try {
        const module = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../../../molecules/dnd5e/Advancements/AbilityScoreImprovement.svelte": () => import("./AbilityScoreImprovement-Ctt_bP9P.js"), "../../../molecules/dnd5e/Advancements/Feat.svelte": () => import("./Feat-16OTxj3Q.js"), "../../../molecules/dnd5e/Advancements/HitPoints.svelte": () => import("./HitPoints-CxHKYrx3.js"), "../../../molecules/dnd5e/Advancements/ItemChoice.svelte": () => import("./ItemChoice-OTnZyo_R.js"), "../../../molecules/dnd5e/Advancements/ItemGrant.svelte": () => import("./ItemGrant-Cm4Sv_09.js"), "../../../molecules/dnd5e/Advancements/ScaleValue.svelte": () => import("./ScaleValue-BdLhBkAm.js"), "../../../molecules/dnd5e/Advancements/Size.svelte": () => import("./Size-CDDSddFW.js"), "../../../molecules/dnd5e/Advancements/Subclass.svelte": () => import("./Subclass-DSM39eh1.js"), "../../../molecules/dnd5e/Advancements/Trait.svelte": () => import("./Trait-D2Q5M-OA.js") }), `../../../molecules/dnd5e/Advancements/${advancement.type}.svelte`, 7);
  ...
  async function updateRichHTML() {
    if ($race) {
      const advancements = getAdvancements($race);
      await importAdvancements(advancements);
      $$invalidate(6, richHTML = await illuminatedDescription($race.system?.description?.value || "", $race));
    }
  }
  onMount(async () => {
    let raceUuid;
  ...
  function iconselect_value_binding(value$1) {
    value = value$1;
    $$invalidate(1, value), $$invalidate(3, $race), $$invalidate(0, active);
  }
  $$self.$$.update = () => {
    ...
    if ($$self.$$.dirty[0] & /*$race*/
    8) {
      $$invalidate(10, advancementArray = getAdvancements($race));
    }
...
//# sourceMappingURL=Race-SP-qUApN.js.map
