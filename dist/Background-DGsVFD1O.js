...
function create_each_block(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      ctx2[19].title + "")) set_data(t_1, t_1_value);
      if (!current || dirty & /*advancementArray*/
...
function create_fragment(ctx) {
  ...
  return {
    c() {
      div7 = element("div");
      h1 = element("h1");
      h1.textContent = `${localize("Tabs.Background.Title")}`;
      div6 = element("div");
      div3 = element("div");
      div2 = element("div");
      div0 = element("div");
...
function instance($$self, $$props, $$invalidate) {
  ...
  let active = null, value = null, placeHolder = localize("Tabs.Backgrounds.Placeholder");
...
//# sourceMappingURL=Background-DGsVFD1O.js.map
