import { S as SvelteComponent, i as init, s as safe_not_equal, e as element, a as empty, b as attr, c as insert, d as append, A as noop, j as detach, o as onMount, z as ensure_array_like, B as destroy_each, F as text, G as set_data, x as log, X as ucfirst, al as writable } from "./index-Ca9W_16m.js";
...
function create_if_block_5(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      ctx2[16].value + "")) set_data(t, t_value);
    },
    d(detaching) {
      if (detaching) {
        detach(div);
...
function create_each_block_2(ctx) {
  ...
  let if_block = (
    /*grant*/
    ctx[16].value && create_if_block_5(ctx)
  );
  return {
    c() {
      div1 = element("div");
...
function create_each_block_1(ctx) {
  ...
  let if_block = (
    /*pool*/
    ctx[13].value && create_if_block_2(ctx)
  );
  return {
    c() {
      div1 = element("div");
...
//# sourceMappingURL=Trait-C5Kz620H.js.map
