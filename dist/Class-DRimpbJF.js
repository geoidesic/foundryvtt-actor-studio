...
function create_if_block(ctx) {
  ...
  let if_block0 = (
    ...
    ctx[1] == 1 && create_if_block_19(ctx)
  );
...
function create_if_block_19(ctx) {
  ...
  return {
    c() {
      ...
      attr(div2, "class", "flexrow svelte-gas-sts5p4");
    },
    m(target, anchor) {
    ...
    p(ctx2, dirty) {
      ...
      524288) iconselect_changes.active = /*subClassProp*/
      ctx2[19];
      if (dirty[0] & /*subclasses*/
...
function create_if_block_18(ctx) {
  ...
  return {
    c() {
      ...
      attr(div1, "class", "flexrow svelte-gas-sts5p4");
    },
    m(target, anchor) {
      insert(target, h3, anchor);
...
function create_if_block_12(ctx) {
  ...
  return {
    c() {
      ...
      attr(div2, "class", "flex0 div badge right inset ml-sm mb-xs svelte-gas-sts5p4");
      attr(h3, "class", "left mt-sm flexrow svelte-gas-sts5p4");
    ...
    p(ctx2, dirty) {
      ...
      if (!/*classAdvancementArrayFiltered*/
      ctx2[8].length && /*classGetsSubclassThisLevel*/
      ctx2[15] && /*classAdvancementExpanded*/
      ctx2[9]) {
        if (if_block3) ;
        else {
...
function create_each_block_1(ctx) {
  ...
  return {
    c() {
      ...
      attr(div3, "class", "flexrow svelte-gas-sts5p4");
      attr(li, "class", "left");
    ...
    p(ctx2, dirty) {
      ...
      131328 && switch_value !== (switch_value = /*classAdvancementComponents*/
      ctx2[17][
        /*advancement*/
        ctx2[48].type
      ])) {
...
function create_if_block_9(ctx) {
  ...
  return {
    c() {
      ...
      attr(div0, "class", "flexrow svelte-gas-sts5p4");
      attr(div1, "class", "flexrow svelte-gas-sts5p4");
    },
    m(target, anchor) {
...
function create_if_block_1(ctx) {
  ...
  let if_block = (
    ...
    ctx[11].length && create_if_block_2(ctx)
  );
  return {
    c() {
...
function create_if_block_2(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      if (
        /*subClassAdvancementArrayFiltered*/
        ctx2[11].length && /*subClassAdvancementExpanded*/
        ctx2[12]
      ) {
        if (if_block3) {
          if_block3.p(ctx2, dirty);
...
function create_each_block(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      2048 && !src_url_equal(img.src, img_src_value = /*advancement*/
      ctx2[48].icon)) {
        attr(img, "src", img_src_value);
      }
      if (!current || dirty[0] & /*subClassAdvancementArrayFiltered*/
      2048 && img_alt_value !== (img_alt_value = /*advancement*/
      ctx2[48].title)) {
        attr(img, "alt", img_alt_value);
      }
      if ((!current || dirty[0] & /*subClassAdvancementArrayFiltered*/
      2048) && t_value !== (t_value = /*advancement*/
      ctx2[48].title + "")) set_data(t, t_value);
      if (!current || dirty[0] & /*subClassAdvancementArrayFiltered*/
      2048 && div2_data_tooltip_value !== (div2_data_tooltip_value = getAdvancementValue(
        /*advancement*/
        ctx2[48]
      ))) {
        attr(div2, "data-tooltip", div2_data_tooltip_value);
      ...
      67584 && switch_value !== (switch_value = /*subClassAdvancementComponents*/
      ctx2[16][
        /*advancement*/
        ctx2[48].type
      ])) {
        ...
        const switch_instance_changes = {};
        if (dirty[0] & /*subClassAdvancementArrayFiltered*/
        2048) switch_instance_changes.advancement = /*advancement*/
        ctx2[48];
        switch_instance.$set(switch_instance_changes);
      }
      if (!current || dirty[0] & /*subClassAdvancementArrayFiltered*/
      2048 && li_data_type_value !== (li_data_type_value = /*advancement*/
      ctx2[48].type)) {
        attr(li, "data-type", li_data_type_value);
      }
    },
...
function create_fragment(ctx) {
  ...
  return {
    c() {
      ...
      attr(div1, "class", "flex3");
      attr(div2, "class", "flexrow svelte-gas-sts5p4");
      attr(div3, "class", "flex2 pr-sm col-a svelte-gas-sts5p4");
      attr(div4, "class", "flex0 border-right right-border-gradient-mask");
      attr(div5, "class", "flex3 left pl-md scroll col-b");
      attr(div6, "class", "flexrow svelte-gas-sts5p4");
      attr(div7, "class", "content svelte-gas-sts5p4");
    },
    m(target, anchor) {
    ...
    p(ctx2, dirty) {
      ...
      262144) iconselect_changes.active = /*classProp*/
      ctx2[18];
      if (dirty[0] & /*filteredClassIndex*/
      8192) iconselect_changes.options = /*filteredClassIndex*/
      ctx2[13];
      if (dirty[0] & /*isDisabled*/
      1) iconselect_changes.disabled = /*isDisabled*/
      ctx2[0];
      ...
      16384) div5.innerHTML = /*combinedHtml*/
      ctx2[14];
    },
    i(local) {
      if (current) return;
...
function instance($$self, $$props, $$invalidate) {
  ...
  const levelSelectHandler = async (option) => {
    $$invalidate(34, subClassesIndex = await getFilteredSubclassIndex());
    await tick();
  ...
  const handleSelectClass = async (option) => {
    ...
    $$invalidate(30, richHTML = await illuminatedDescription(html, $characterClass));
    Hooks.call("gas.richhtmlReady", richHTML);
  };
  const importClassAdvancements = async () => {
    $$invalidate(17, classAdvancementComponents = {});
    for (const classAdvancement of classAdvancementArrayFiltered) {
      try {
        const module = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../../../molecules/dnd5e/Advancements/AbilityScoreImprovement.svelte": () => import("./AbilityScoreImprovement-CvemZ7HT.js"), "../../../molecules/dnd5e/Advancements/Feat.svelte": () => import("./Feat-LaJAFrc2.js"), "../../../molecules/dnd5e/Advancements/HitPoints.svelte": () => import("./HitPoints-gCqVCTqV.js"), "../../../molecules/dnd5e/Advancements/ItemChoice.svelte": () => import("./ItemChoice-WzQApXuI.js"), "../../../molecules/dnd5e/Advancements/ItemGrant.svelte": () => import("./ItemGrant-CEHgd8nm.js"), "../../../molecules/dnd5e/Advancements/ScaleValue.svelte": () => import("./ScaleValue-DVn_epFe.js"), "../../../molecules/dnd5e/Advancements/Size.svelte": () => import("./Size-DVwtSOzT.js"), "../../../molecules/dnd5e/Advancements/Subclass.svelte": () => import("./Subclass-KLVdwcMV.js"), "../../../molecules/dnd5e/Advancements/Trait.svelte": () => import("./Trait-DR50VYwG.js") }), `../../../molecules/dnd5e/Advancements/${classAdvancement.type}.svelte`, 7);
        $$invalidate(17, classAdvancementComponents[classAdvancement.type] = module.default, classAdvancementComponents);
        await tick();
      } catch (error) {
  ...
  const handleSelectSubClass = async (option) => {
    ...
    $$invalidate(33, activeSubClass = option);
    if (!subclassValue) {
    ...
    importClassAdvancements();
    importSubClassAdvancements();
    $$invalidate(31, richSubClassHTML = await illuminatedDescription($characterSubClass.system.description.value, $characterSubClass));
  };
  const importSubClassAdvancements = async () => {
    for (const subClassAdvancement of subClassAdvancementArrayFiltered) {
      try {
        const module = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../../../molecules/dnd5e/Advancements/AbilityScoreImprovement.svelte": () => import("./AbilityScoreImprovement-CvemZ7HT.js"), "../../../molecules/dnd5e/Advancements/Feat.svelte": () => import("./Feat-LaJAFrc2.js"), "../../../molecules/dnd5e/Advancements/HitPoints.svelte": () => import("./HitPoints-gCqVCTqV.js"), "../../../molecules/dnd5e/Advancements/ItemChoice.svelte": () => import("./ItemChoice-WzQApXuI.js"), "../../../molecules/dnd5e/Advancements/ItemGrant.svelte": () => import("./ItemGrant-CEHgd8nm.js"), "../../../molecules/dnd5e/Advancements/ScaleValue.svelte": () => import("./ScaleValue-DVn_epFe.js"), "../../../molecules/dnd5e/Advancements/Size.svelte": () => import("./Size-DVwtSOzT.js"), "../../../molecules/dnd5e/Advancements/Subclass.svelte": () => import("./Subclass-KLVdwcMV.js"), "../../../molecules/dnd5e/Advancements/Trait.svelte": () => import("./Trait-DR50VYwG.js") }), `../../../molecules/dnd5e/Advancements/${subClassAdvancement.type}.svelte`, 7);
        await tick();
        $$invalidate(16, subClassAdvancementComponents[subClassAdvancement.type] = module.default, subClassAdvancementComponents);
      } catch (error) {
  ...
  const toggleEquipmentSelection = () => {
    $$invalidate(10, equipmentSelectionExpanded = !equipmentSelectionExpanded);
  };
  const toggleSubClassAdvancements = () => {
    $$invalidate(12, subClassAdvancementExpanded = !subClassAdvancementExpanded);
  };
  onMount(async () => {
  ...
  $$self.$$.update = () => {
    ...
    4) {
      $$invalidate(19, subClassProp = activeSubClass);
    }
    if ($$self.$$.dirty[1] & /*selectedCharacterClass*/
    2) {
      $$invalidate(18, classProp = selectedCharacterClass);
    }
    if ($$self.$$.dirty[0] & /*$characterClass*/
    8) {
    ...
    18) {
      $$invalidate(15, classGetsSubclassThisLevel = subClassLevel && subClassLevel === $level);
    }
    if ($$self.$$.dirty[1] & /*$readOnlyTabs*/
    16) {
      $$invalidate(0, isDisabled = $readOnlyTabs.includes("class"));
    }
    if ($$self.$$.dirty[0] & /*$characterClass, richHTML*/
    1073741832 | $$self.$$.dirty[1] & /*richSubClassHTML*/
    1) {
      $$invalidate(14, combinedHtml = $characterClass ? `
      ${richHTML}
  ...
  ` : "");
    ...
    20) {
      if ($characterSubClass?.system?.advancement.length) {
        $$invalidate(11, subClassAdvancementArrayFiltered = $characterSubClass.system.advancement.filter((value) => value.level === $level));
      } else {
        $$invalidate(11, subClassAdvancementArrayFiltered = []);
      }
    }
  ...
  $$invalidate(17, classAdvancementComponents = {});
  $$invalidate(16, subClassAdvancementComponents = {});
  return [
    isDisabled,
    subClassLevel,
    $characterSubClass,
...
//# sourceMappingURL=Class-DRimpbJF.js.map
