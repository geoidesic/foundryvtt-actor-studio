...
function create_if_block$2(ctx) {
  ...
  return {
    c() {
      ...
      (ctx[2] ? "flex2" : "flex0"));
      attr(div4, "class", "flex3 flexrow");
      attr(div5, "class", "flexrow class-row svelte-gas-1lozflz");
    },
    m(target, anchor) {
    ...
    p(ctx2, dirty) {
      ...
      if (dirty & /*$readOnlyTabs*/
      32) show_if = !/*$readOnlyTabs*/
      ctx2[5].includes("level-up");
      if (show_if) {
        if (if_block) {
...
function create_if_block_1$2(ctx) {
  ...
  return {
    c() {
      ...
      attr(div, "class", "flex0 right pr-md py-xs");
    },
    m(target, anchor) {
...
function instance$3($$self, $$props, $$invalidate) {
  ...
  return [src, oldLevel, newLevel, classKey, iconClass, $readOnlyTabs];
}
...
function instance$1($$self, $$props, $$invalidate) {
  ...
  const importClassAdvancements = async () => {
    for (const classAdvancement of classAdvancementArrayFiltered) {
      try {
        const module = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../../components/molecules/dnd5e/Advancements/AbilityScoreImprovement.svelte": () => import("./AbilityScoreImprovement-CLFB_8H4.js"), "../../components/molecules/dnd5e/Advancements/Feat.svelte": () => import("./Feat-YXhHZKFh.js"), "../../components/molecules/dnd5e/Advancements/HitPoints.svelte": () => import("./HitPoints-K0VD17F8.js"), "../../components/molecules/dnd5e/Advancements/ItemChoice.svelte": () => import("./ItemChoice-C29auHpt.js"), "../../components/molecules/dnd5e/Advancements/ItemGrant.svelte": () => import("./ItemGrant-BlahLR5T.js"), "../../components/molecules/dnd5e/Advancements/ScaleValue.svelte": () => import("./ScaleValue-irLPwiHm.js"), "../../components/molecules/dnd5e/Advancements/Size.svelte": () => import("./Size-Cyl8VHzo.js"), "../../components/molecules/dnd5e/Advancements/Subclass.svelte": () => import("./Subclass-C2Y_-sZ2.js"), "../../components/molecules/dnd5e/Advancements/Trait.svelte": () => import("./Trait-tDSNFiet.js") }), `../../components/molecules/dnd5e/Advancements/${classAdvancement.type}.svelte`, 7);
...
function create_if_block_11(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      4) classlevelrow_changes.imgSrc = /*getters*/
      ctx2[20].getCharacterClass(
        /*classKey*/
        ctx2[48]
      )?.img;
      if (dirty[0] & /*classKeys*/
      4) classlevelrow_changes.cssClasses = /*decorators*/
      ctx2[19].existingClassesCssClassForRow(
        /*classKey*/
        ctx2[48]
      );
      if (dirty[0] & /*classKeys*/
      4) classlevelrow_changes.eventHandler = /*eventHandlers*/
      ...
      if (dirty[0] & /*classKeys*/
      4) classlevelrow_changes.classKey = /*classKey*/
      ctx2[48];
      if (dirty[0] & /*classKeys*/
      4) classlevelrow_changes.tooltip = /*getters*/
      ctx2[20].rowTooltip(
        /*classKey*/
        ctx2[48]
      );
      if (dirty[0] & /*$classUuidForLevelUp*/
      16) classlevelrow_changes.iconClass = /*$classUuidForLevelUp*/
      ctx2[4] ? "" : "fas fa-plus";
...
function create_if_block_10(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      32) classlevelrow_changes.newLevel = /*$newLevelValueForExistingClass*/
      ctx2[5];
      if (dirty[0] & /*classKeys*/
      4) classlevelrow_changes.tooltip = /*getters*/
      ctx2[20].rowTooltip(
...
function create_if_block_1(ctx) {
  ...
  let current;
  let if_block0 = selectedMultiClassUUID && create_if_block_6();
  ...
  let if_block1 = (
    /*subclasses*/
    ctx[0].length && /*$levelUpClassGetsSubclassThisLevel*/
    ctx[15] && (window.GAS.dnd5eVersion < 4 || window.GAS.dnd5eRules == "2014") && create_if_block_5()
  );
  let if_block2 = (
    /*subclasses*/
    ctx[0].length && /*$levelUpClassGetsSubclassThisLevel*/
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      ctx2[8];
      if (dirty[0] & /*newLevel*/
      2) leftcoldetails_changes.level = /*newLevel*/
      ctx2[1];
      leftcoldetails.$set(leftcoldetails_changes);
      if (
        /*subclasses*/
        ctx2[0].length && /*$levelUpClassGetsSubclassThisLevel*/
      ...
      if (
        ...
        if (if_block2) {
          ...
          if (dirty[0] & /*subclasses, $levelUpClassGetsSubclassThisLevel*/
          32769) {
...
function create_if_block_3(ctx) {
  ...
  let updating_value;
  let current;
  let if_block = window.GAS.debug && create_if_block_4();
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      1) iconselect_changes.options = /*subclasses*/
      ctx2[0];
      if (dirty[0] & /*$isLevelUpAdvancementInProgress*/
...
function create_if_block_2(ctx) {
  ...
  return {
    c() {
      p = element("p");
      p.innerHTML = `<i class="fas fa-exclamation-triangle icon left mr-sm" style="color: #ff6b6b;"></i>No subclasses available. Ask your GM to check compendium sources for subclasses are assigned in the settings.`;
    },
    m(target, anchor) {
      insert(target, p, anchor);
    },
...
function create_if_block(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      8 && t_1_value !== (t_1_value = /*$levelUpClassObject*/
      (ctx2[3]?.name || "") + "")) set_data(t_1, t_1_value);
    },
    d(detaching) {
      if (detaching) {
        detach(h1);
...
function create_fragment(ctx) {
  ...
  let html_tag;
  let current;
  let if_block0 = window.GAS.debug && create_if_block_13();
...
function instance($$self, $$props, $$invalidate) {
  ...
  component_subscribe($$self, classUuidForLevelUp, ($$value) => $$invalidate(4, $classUuidForLevelUp = $$value));
  component_subscribe($$self, newLevelValueForExistingClass, ($$value) => $$invalidate(5, $newLevelValueForExistingClass = $$value));
  component_subscribe($$self, isNewMultiClassSelected, ($$value) => $$invalidate(26, $isNewMultiClassSelected = $$value));
  component_subscribe($$self, selectedMultiClassUUID, ($$value) => $$invalidate(6, $selectedMultiClassUUID = $$value));
  ...
  const importers = {
    async importClassAdvancements() {
      ...
      for (const classAdvancement of classAdvancementArrayFiltered) {
        try {
          const module = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../../../molecules/dnd5e/Advancements/AbilityScoreImprovement.svelte": () => import("./AbilityScoreImprovement-CLFB_8H4.js"), "../../../molecules/dnd5e/Advancements/Feat.svelte": () => import("./Feat-YXhHZKFh.js"), "../../../molecules/dnd5e/Advancements/HitPoints.svelte": () => import("./HitPoints-K0VD17F8.js"), "../../../molecules/dnd5e/Advancements/ItemChoice.svelte": () => import("./ItemChoice-C29auHpt.js"), "../../../molecules/dnd5e/Advancements/ItemGrant.svelte": () => import("./ItemGrant-BlahLR5T.js"), "../../../molecules/dnd5e/Advancements/ScaleValue.svelte": () => import("./ScaleValue-irLPwiHm.js"), "../../../molecules/dnd5e/Advancements/Size.svelte": () => import("./Size-Cyl8VHzo.js"), "../../../molecules/dnd5e/Advancements/Subclass.svelte": () => import("./Subclass-C2Y_-sZ2.js"), "../../../molecules/dnd5e/Advancements/Trait.svelte": () => import("./Trait-tDSNFiet.js") }), `../../../molecules/dnd5e/Advancements/${classAdvancement.type}.svelte`, 7);
    ...
    async importSubClassAdvancements() {
      ...
      for (const subClassAdvancement of subClassAdvancementArrayFiltered) {
        try {
          const module = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../../../molecules/dnd5e/Advancements/AbilityScoreImprovement.svelte": () => import("./AbilityScoreImprovement-CLFB_8H4.js"), "../../../molecules/dnd5e/Advancements/Feat.svelte": () => import("./Feat-YXhHZKFh.js"), "../../../molecules/dnd5e/Advancements/HitPoints.svelte": () => import("./HitPoints-K0VD17F8.js"), "../../../molecules/dnd5e/Advancements/ItemChoice.svelte": () => import("./ItemChoice-C29auHpt.js"), "../../../molecules/dnd5e/Advancements/ItemGrant.svelte": () => import("./ItemGrant-BlahLR5T.js"), "../../../molecules/dnd5e/Advancements/ScaleValue.svelte": () => import("./ScaleValue-irLPwiHm.js"), "../../../molecules/dnd5e/Advancements/Size.svelte": () => import("./Size-Cyl8VHzo.js"), "../../../molecules/dnd5e/Advancements/Subclass.svelte": () => import("./Subclass-C2Y_-sZ2.js"), "../../../molecules/dnd5e/Advancements/Trait.svelte": () => import("./Trait-tDSNFiet.js") }), `../../../molecules/dnd5e/Advancements/${subClassAdvancement.type}.svelte`, 7);
          await tick();
  ...
  const eventHandlers = {
    ...
    */
    clickAddLevel: async (classKey) => {
      if ($readOnlyTabs.includes("level-up")) return;
  ...
  $$self.$$.update = () => {
    ...
    134217728) {
      $$invalidate(24, classes = window.GAS.dnd5eVersion >= 4 ? $actor.classes : $actor._classes);
    }
    if ($$self.$$.dirty[0] & /*classes*/
    16777216) {
      $$invalidate(2, classKeys = Object.keys(classes));
    }
    ...
    67108896) {
      $$invalidate(1, newLevel = $isNewMultiClassSelected ? 1 : $newLevelValueForExistingClass);
    }
    ...
    if ($$self.$$.dirty[0] & /*subClassesIndex, subclasses*/
    4194305) {
      if (subClassesIndex?.length) {
        $$invalidate(0, subclasses = subClassesIndex.flat().sort((a, b) => a.label.localeCompare(b.label)));
        window.GAS.log.d("[DEBUG] subclasses set from subClassesIndex:", subclasses);
      } else {
        $$invalidate(0, subclasses = []);
...
//# sourceMappingURL=LevelUp-4rnzrNbJ.js.map
