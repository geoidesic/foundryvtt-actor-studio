import { S as SvelteComponent, i as init, s as safe_not_equal, B as ensure_array_like, C as noop, d as detach, D as destroy_each, j as attr, b as insert, e as append, f as element, o as onMount, N as src_url_equal, h as empty, F as set_data, G as text } from "./index-BZvewgTP.js";
...
function create_if_block(ctx) {
  ...
  handle_promise(promise = foundry.applications.ux.TextEditor.implementation.enrichHTML(
    /*item*/
    ctx[4].link || ""
  ), info);
  return {
    ...
    p(new_ctx, dirty) {
      ...
      info.ctx = ctx;
      if (dirty & /*items*/
      2 && promise !== (promise = foundry.applications.ux.TextEditor.implementation.enrichHTML(
        /*item*/
        ctx[4].link || ""
...
//# sourceMappingURL=ItemGrant-CIZ8v3pm.js.map
