import { S as SvelteComponent, i as init, s as safe_not_equal, C as noop, k as detach, x as attr, q as insert, u as append, v as element, w as empty, o as onMount, B as ensure_array_like, D as destroy_each, F as set_data, G as text, aR as ucfirst, a1 as writable } from "./index-vMRrMX6I.js";
...
function create_if_block_5(ctx) {
  ...
  return {
    c() {
      div = element("div");
      t = text(t_value);
      attr(div, "class", "flex0 right badge inset nowrap svelte-gas-1v6xl8s");
    },
    m(target, anchor) {
...
function create_else_block_1(ctx) {
  ...
  return {
    c() {
      ...
      attr(div1, "class", "flex0 badge inset right svelte-gas-1v6xl8s");
...
function create_else_block(ctx) {
  ...
  return {
    c() {
      ...
      attr(div, "class", "flex0 right badge inset svelte-gas-1v6xl8s");
    },
    m(target, anchor) {
      insert(target, div, anchor);
    },
...
function create_fragment(ctx) {
  ...
  return {
    c() {
      ...
      attr(div, "class", "advancement mt-sm svelte-gas-1v6xl8s");
...
//# sourceMappingURL=Trait-D_UgGAi8.js.map
