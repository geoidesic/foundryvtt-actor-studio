import { S as SvelteComponent, i as init, s as safe_not_equal, C as noop, k as detach, x as attr, q as insert, v as element, o as onMount, O as getAdvancementValue, u as append, w as empty, F as set_data, G as text, B as ensure_array_like, D as destroy_each } from "./index-Vm_z90HH.js";
...
function create_each_block(ctx) {
  ...
  return {
    c() {
      div = element("div");
      t = text(t_value);
      attr(div, "class", "flex0 right badge svelte-gas-atabig");
    },
    m(target, anchor) {
      insert(target, div, anchor);
      append(div, t);
...
function create_fragment(ctx) {
  ...
  return {
    c() {
      ...
      attr(div, "class", "advancement mt-sm svelte-gas-atabig");
...
//# sourceMappingURL=Size-BhtaQthv.js.map
