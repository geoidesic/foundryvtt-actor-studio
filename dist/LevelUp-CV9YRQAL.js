import { S as SvelteComponent, i as init, s as safe_not_equal, C as noop, d as detach, b as insert, h as empty, o as onMount, ar as ucfirst, N as src_url_equal, j as attr, F as set_data, as as null_to_empty, e as append, f as element, G as text, Z as space, x as destroy_component, t as transition_out, a as transition_in, z as mount_component, Y as listen, ab as is_function, A as create_component, k as component_subscribe, at as isLevelUpAdvancementInProgress, g as group_outros, c as check_outros, q as tick, _ as __variableDynamicImportRuntimeHelper, l as localize, B as ensure_array_like, D as destroy_each, E as construct_svelte_component, O as getAdvancementValue, au as HtmlTag, av as levelUpPreAdvancementSelections, aw as levelUpClassObject, ax as levelUpCombinedHtml, ay as levelUpRichHTML, az as classUuidForLevelUp, aA as newLevelValueForExistingClass, aB as isNewMultiClassSelected, aC as selectedMultiClassUUID, aD as subClassUuidForLevelUp, aE as levelUpSubClassObject, aF as activeRowClassKey, aG as levelUpClassGetsSubclassThisLevel, J as getPacksFromSettings, K as extractItemsFromPacksSync, n as getContext, aH as onDestroy, u as set_store_value, v as binding_callbacks, w as bind, y as add_flush_callback, L as illuminatedDescription, aI as set_style, M as MODULE_ID, aJ as extractMapIteratorObjectProperties } from "./index-BMUnl0DC.js";
import { I as IconSelect } from "./IconSelect-CbAyccJh.js";
...
function instance$1($$self, $$props, $$invalidate) {
  ...
  const importClassAdvancements = async () => {
    for (const classAdvancement of classAdvancementArrayFiltered) {
      try {
        const module = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../../components/molecules/dnd5e/Advancements/AbilityScoreImprovement.svelte": () => import("./AbilityScoreImprovement-DNghUpW9.js"), "../../components/molecules/dnd5e/Advancements/Feat.svelte": () => import("./Feat-BgJknnZp.js"), "../../components/molecules/dnd5e/Advancements/HitPoints.svelte": () => import("./HitPoints-BSd17DIe.js"), "../../components/molecules/dnd5e/Advancements/ItemChoice.svelte": () => import("./ItemChoice-CmOI13d0.js"), "../../components/molecules/dnd5e/Advancements/ItemGrant.svelte": () => import("./ItemGrant-CxrC25rC.js"), "../../components/molecules/dnd5e/Advancements/ScaleValue.svelte": () => import("./ScaleValue-Bg9n5YWs.js"), "../../components/molecules/dnd5e/Advancements/Size.svelte": () => import("./Size-DXIItxiE.js"), "../../components/molecules/dnd5e/Advancements/Subclass.svelte": () => import("./Subclass-DnVXWh_a.js"), "../../components/molecules/dnd5e/Advancements/Trait.svelte": () => import("./Trait-BcATidlq.js") }), `../../components/molecules/dnd5e/Advancements/${classAdvancement.type}.svelte`, 7);
...
function create_if_block_4(ctx) {
  ...
  return {
    c() {
      ...
      div2 = element("div");
      div0 = element("div");
      div0.innerHTML = `<img class="icon" src="${`modules/${MODULE_ID}/assets/dnd5e/3.x/subclass.svg`}" alt="${localize("GAS.AltText.Subclass")}"/>`;
      div1 = element("div");
...
function instance($$self, $$props, $$invalidate) {
  ...
  let subclassValue = null, subClassesIndex = [], classAdvancementArrayFiltered = [], subClassAdvancementArrayFiltered = [], classesPlaceholder = localize(
    "GAS.LevelUp.SelectMulticlass"
  ), richSubClassHTML = "", packs = getPacksFromSettings("classes"), subclasses, subClassesPacks = getPacksFromSettings("subclasses"), subclassesPlaceholder = localize("GAS.Tabs.Classes.SubclassPlaceholder"), mapKeys = ["name->label", "img", "type", "folder", "uuid->value", "_id"], mappedClassIndex = extractItemsFromPacksSync(
    packs,
    mapKeys
  );
  ...
  const importers = {
    async importClassAdvancements() {
      ...
      for (const classAdvancement of classAdvancementArrayFiltered) {
        try {
          const module = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../../../molecules/dnd5e/Advancements/AbilityScoreImprovement.svelte": () => import("./AbilityScoreImprovement-DNghUpW9.js"), "../../../molecules/dnd5e/Advancements/Feat.svelte": () => import("./Feat-BgJknnZp.js"), "../../../molecules/dnd5e/Advancements/HitPoints.svelte": () => import("./HitPoints-BSd17DIe.js"), "../../../molecules/dnd5e/Advancements/ItemChoice.svelte": () => import("./ItemChoice-CmOI13d0.js"), "../../../molecules/dnd5e/Advancements/ItemGrant.svelte": () => import("./ItemGrant-CxrC25rC.js"), "../../../molecules/dnd5e/Advancements/ScaleValue.svelte": () => import("./ScaleValue-Bg9n5YWs.js"), "../../../molecules/dnd5e/Advancements/Size.svelte": () => import("./Size-DXIItxiE.js"), "../../../molecules/dnd5e/Advancements/Subclass.svelte": () => import("./Subclass-DnVXWh_a.js"), "../../../molecules/dnd5e/Advancements/Trait.svelte": () => import("./Trait-BcATidlq.js") }), `../../../molecules/dnd5e/Advancements/${classAdvancement.type}.svelte`, 7);
    ...
    async importSubClassAdvancements() {
      ...
      for (const subClassAdvancement of subClassAdvancementArrayFiltered) {
        try {
          const module = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../../../molecules/dnd5e/Advancements/AbilityScoreImprovement.svelte": () => import("./AbilityScoreImprovement-DNghUpW9.js"), "../../../molecules/dnd5e/Advancements/Feat.svelte": () => import("./Feat-BgJknnZp.js"), "../../../molecules/dnd5e/Advancements/HitPoints.svelte": () => import("./HitPoints-BSd17DIe.js"), "../../../molecules/dnd5e/Advancements/ItemChoice.svelte": () => import("./ItemChoice-CmOI13d0.js"), "../../../molecules/dnd5e/Advancements/ItemGrant.svelte": () => import("./ItemGrant-CxrC25rC.js"), "../../../molecules/dnd5e/Advancements/ScaleValue.svelte": () => import("./ScaleValue-Bg9n5YWs.js"), "../../../molecules/dnd5e/Advancements/Size.svelte": () => import("./Size-DXIItxiE.js"), "../../../molecules/dnd5e/Advancements/Subclass.svelte": () => import("./Subclass-DnVXWh_a.js"), "../../../molecules/dnd5e/Advancements/Trait.svelte": () => import("./Trait-BcATidlq.js") }), `../../../molecules/dnd5e/Advancements/${subClassAdvancement.type}.svelte`, 7);
          await tick();
...
//# sourceMappingURL=LevelUp-CV9YRQAL.js.map
