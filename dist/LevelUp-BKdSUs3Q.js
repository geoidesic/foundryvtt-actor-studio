import { S as SvelteComponent, i as init, s as safe_not_equal, z as ensure_array_like, e as element, a as empty, b as attr, c as insert, d as append, h as transition_in, g as group_outros, t as transition_out, f as check_outros, j as detach, B as destroy_each, k as component_subscribe, P as characterClass, O as characterSubClass, W as newClassLevel, X as activeClass, Q as level, K as getPacksFromSettings, L as extractItemsFromPacks, n as getContext, o as onMount, q as tick, x as log, l as localize, R as DonationTracker, Y as ucfirst, F as text, U as space, N as src_url_equal, Z as listen, $ as is_function, G as set_data, u as create_component, v as mount_component, w as destroy_component, V as extractMapIteratorObjectProperties, _ as __variableDynamicImportRuntimeHelper, y as set_store_value } from "./index-BGuIGNHb.js";
/* empty css                                                  */
import LevelUpExistingClassLeftCol from "./LevelUpExistingClassLeftCol-BolZuqN4.js";
...
function create_each_block(ctx) {
  ...
  return {
    c() {
      ...
      ctx[4] ? "active" : "") + " svelte-gas-4c5pwm");
    ...
    p(new_ctx, dirty) {
      ...
      2 && !src_url_equal(img.src, img_src_value = /*getCharacterClass*/
      ctx[10](
        /*classKey*/
        ctx[47]
      )?.img)) {
      ...
      if (dirty[0] & /*classKeys*/
      2 && t0_value !== (t0_value = ucfirst(
        /*classKey*/
        ctx[47]
      ) + "")) set_data(t0, t0_value);
      if (dirty[0] & /*classLevels*/
      4 && t2_value !== (t2_value = /*classLevels*/
      ctx[2][
        /*index*/
        ctx[49]
      ...
      18 && div6_class_value !== (div6_class_value = "class-row gold-button flexrow " + /*getCharacterClass*/
      (ctx[10](
        /*classKey*/
        ctx[47]
      ).uuid === /*$activeClass*/
      ...
      if (dirty[0] & /*classKeys*/
      2 && div6_aria_label_value !== (div6_aria_label_value = localize("GAS.LevelUp.Button") + " " + /*classKey*/
      ctx[47])) {
        attr(div6, "aria-label", div6_aria_label_value);
      }
      if (dirty[0] & /*classKeys*/
      2 && div6_data_tooltip_value !== (div6_data_tooltip_value = localize("GAS.LevelUp.Button") + " " + /*classKey*/
      ctx[47])) {
...
function instance($$self, $$props, $$invalidate) {
  ...
  let richHTML = "", richSubClassHTML = "", activeClassKey = null, activeSubClass = null, subClassesIndex, packs = getPacksFromSettings("classes");
  ...
  const importClassAdvancements = async () => {
    for (const classAdvancement of classAdvancementArrayFiltered) {
      try {
        const module = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../../../molecules/dnd5e/Advancements/AbilityScoreImprovement.svelte": () => import("./AbilityScoreImprovement-BREw2mKD.js"), "../../../molecules/dnd5e/Advancements/Feat.svelte": () => import("./Feat-a0cLcwLw.js"), "../../../molecules/dnd5e/Advancements/ItemChoice.svelte": () => import("./ItemChoice-BOVNnGKV.js"), "../../../molecules/dnd5e/Advancements/ItemGrant.svelte": () => import("./ItemGrant-Cr9xlzto.js"), "../../../molecules/dnd5e/Advancements/ScaleValue.svelte": () => import("./ScaleValue-BkO9GS3O.js"), "../../../molecules/dnd5e/Advancements/Size.svelte": () => import("./Size-B5jTvvkA.js"), "../../../molecules/dnd5e/Advancements/Trait.svelte": () => import("./Trait-CN_D-jbH.js") }), `../../../molecules/dnd5e/Advancements/${classAdvancement.type}.svelte`, 7);
  ...
  const importSubClassAdvancements = async () => {
    for (const subClassAdvancement of subClassAdvancementArrayFiltered) {
      try {
        const module = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../../../molecules/dnd5e/Advancements/AbilityScoreImprovement.svelte": () => import("./AbilityScoreImprovement-BREw2mKD.js"), "../../../molecules/dnd5e/Advancements/Feat.svelte": () => import("./Feat-a0cLcwLw.js"), "../../../molecules/dnd5e/Advancements/ItemChoice.svelte": () => import("./ItemChoice-BOVNnGKV.js"), "../../../molecules/dnd5e/Advancements/ItemGrant.svelte": () => import("./ItemGrant-Cr9xlzto.js"), "../../../molecules/dnd5e/Advancements/ScaleValue.svelte": () => import("./ScaleValue-BkO9GS3O.js"), "../../../molecules/dnd5e/Advancements/Size.svelte": () => import("./Size-B5jTvvkA.js"), "../../../molecules/dnd5e/Advancements/Trait.svelte": () => import("./Trait-CN_D-jbH.js") }), `../../../molecules/dnd5e/Advancements/${subClassAdvancement.type}.svelte`, 7);
        await tick();
...
//# sourceMappingURL=LevelUp-BKdSUs3Q.js.map
