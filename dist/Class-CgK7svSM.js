...
function create_if_block_14(ctx) {
  ...
  return {
    c() {
      h2 = element("h2");
      h2.textContent = `${localize$1("GAS.SubClass")}`;
      div2 = element("div");
      div0 = element("div");
      t1 = text("*");
      div1 = element("div");
...
function create_if_block_13(ctx) {
  ...
  return {
    c() {
      h2 = element("h2");
      h2.textContent = `${localize$1("GAS.Tabs.Classes.FilterByLevel")}`;
      div1 = element("div");
      div0 = element("div");
...
function create_if_block_7(ctx) {
  ...
  let div1;
  let div2;
  let t3_value = localize$1("GAS.Level") + "";
  let t3;
  let t4;
  let t5;
  let ul;
  ...
  return {
    c() {
      ...
      if (if_block1) if_block1.c();
      div1 = element("div");
      div1.textContent = `${localize$1("GAS.Tabs.Classes.Class")} ${localize$1("GAS.Advancements")}`;
      div2 = element("div");
      t3 = text(t3_value);
      t4 = space();
      t5 = text(
...
function create_if_block_10(ctx) {
  ...
  return {
    c() {
      li = element("li");
      li.textContent = `${localize$1("GAS.NoAdvancements")}`;
      attr(li, "class", "left");
    },
    m(target, anchor) {
...
function create_if_block_9(ctx) {
  ...
  return {
    c() {
      ...
      img = element("img");
      div1 = element("div");
      div1.textContent = `${localize$1("GAS.SubClass")}`;
      attr(img, "class", "icon");
      if (!src_url_equal(img.src, img_src_value = "systems/dnd5e/icons/svg/items/subclass.svg")) attr(img, "src", img_src_value);
      attr(img, "alt", localize("GAS.AltText.Subclass"));
...
function create_if_block_2(ctx) {
  ...
  return {
    c() {
      ...
      if (if_block1) if_block1.c();
      div1 = element("div");
      div1.textContent = `${localize$1("GAS.Tabs.Classes.SubClass")} ${localize$1("GAS.Advancements")}`;
      div2 = element("div");
      t3 = text(t3_value);
      t4 = space();
      t5 = text(
...
function create_fragment(ctx) {
  ...
  return {
    c() {
      div7 = element("div");
      h1 = element("h1");
      h1.textContent = `${localize$1("GAS.Tabs.Classes.Title")}`;
      div6 = element("div");
      div3 = element("div");
      div2 = element("div");
      div0 = element("div");
...
function instance($$self, $$props, $$invalidate) {
  ...
  for (let i = 1; i <= 20; i++) {
    levelOptions.push({
      label: localize("GAS.Tabs.Classes.Level") + " " + i,
      value: i
    });
  }
  const selectStyles = {};
  ...
  $$self.$$.update = () => {
    ...
    805306376) {
      ...
      ${richHTML}
      ${richSubClassHTML ? `<h1>${localize$1("GAS.SubClass")}</h1>${richSubClassHTML}` : ""}
  ` : "");
    }
...
//# sourceMappingURL=Class-CgK7svSM.js.map
