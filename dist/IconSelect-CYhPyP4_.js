import { S as SvelteComponent, i as init, s as safe_not_equal, B as ensure_array_like, aS as assign, C as noop, d as detach, D as destroy_each, a0 as run_all, j as attr, aT as toggle_class, aU as set_attributes, aV as get_spread_update, b as insert, e as append, Y as listen, f as element, h as empty, aW as compute_rest_props, M as MODULE_ID, o as onMount, aP as onDestroy, aX as exclude_internal_props, F as set_data, G as text, aY as truncate, ah as is_function, aA as null_to_empty, N as src_url_equal } from "./index-wTwGMCER.js";
...
function create_if_block_4(ctx) {
  ...
  return {
    c() {
      ...
      div = element("div");
      t = text(t_value);
      attr(div, "class", "option-label svelte-gas-1tf9752");
    },
    m(target, anchor) {
...
function create_else_block_1(ctx) {
  ...
  return {
    c() {
      ...
      ctx[17].label);
      attr(img, "class", "svelte-gas-1tf9752");
    },
    m(target, anchor) {
...
function create_if_block(ctx) {
  ...
  return {
    c() {
      ...
      attr(div, "class", "options-dropdown dropshadow svelte-gas-1tf9752");
...
function create_if_block_1(ctx) {
  ...
  return {
    c() {
      ...
      div0 = element("div");
      t = text(t_value);
      attr(div0, "class", "option-label svelte-gas-1tf9752");
      attr(div1, "class", "option svelte-gas-1tf9752");
...
function create_fragment(ctx) {
  ...
  return {
    c() {
      ...
      div0 = element("div");
      div0.innerHTML = `<i class="fas fa-chevron-down svelte-gas-1tf9752"></i>`;
      if (if_block1) if_block1.c();
      attr(div0, "class", "chevron-icon svelte-gas-1tf9752");
      attr(div1, "class", "selected-option svelte-gas-1tf9752");
      ...
      toggle_class(div2, "svelte-gas-1tf9752", true);
    },
    m(target, anchor) {
...
//# sourceMappingURL=IconSelect-CYhPyP4_.js.map
