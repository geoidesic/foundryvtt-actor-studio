import { S as SvelteComponent, i as init, s as safe_not_equal, C as noop, k as detach, x as attr, q as insert, v as element, o as onMount, O as getAdvancementValue, F as set_data, u as append, G as text, B as ensure_array_like, D as destroy_each, w as empty, N as src_url_equal } from "./index-B1LFoHcD.js";
...
function create_else_block(ctx) {
  ...
  return {
    c() {
      ...
      attr(h4, "class", "flex left");
      attr(div, "class", "flexrow svelte-gas-1p18jyw");
      attr(ul, "class", "icon-list svelte-gas-1p18jyw");
    },
    m(target, anchor) {
    ...
    p(ctx2, dirty) {
      ...
      if (dirty & /*fromUuid, advancement, getErrorMessage*/
      1) {
...
function create_if_block(ctx) {
  ...
  return {
    c() {
      ...
      attr(div1, "class", "flexrow svelte-gas-1p18jyw");
    },
    m(target, anchor) {
...
function create_catch_block(ctx) {
  ...
  return {
    c() {
      ...
      div2 = element("div");
      div0 = element("div");
      div0.innerHTML = `<i class="fas fa-exclamation-triangle icon" style="color: #ff6b6b;"></i>`;
      div1 = element("div");
      t = text(t_value);
      attr(div0, "class", "flex0 relative image svelte-gas-1p18jyw");
      attr(div1, "class", "flex2 svelte-gas-1p18jyw");
      attr(div2, "class", "flexrow svelte-gas-1p18jyw");
      attr(li, "class", "left error-item svelte-gas-1p18jyw");
    },
    m(target, anchor) {
    ...
    p(ctx2, dirty) {
      if (dirty & /*advancement*/
      1 && t_value !== (t_value = getErrorMessage(
        /*pool*/
        ctx2[2].uuid
      ) + "")) set_data(t, t_value);
    },
...
function create_if_block_1(ctx) {
  ...
  return {
    c() {
      ...
      div1 = element("div");
      t = text(t_value);
      attr(img, "class", "icon svelte-gas-1p18jyw");
      ...
      attr(div1, "class", "flex2 svelte-gas-1p18jyw");
      attr(div2, "class", "flexrow svelte-gas-1p18jyw");
      attr(li, "class", "left svelte-gas-1p18jyw");
    },
    m(target, anchor) {
      insert(target, li, anchor);
      append(li, div2);
...
function create_fragment(ctx) {
  ...
  return {
    c() {
      div = element("div");
      if_block.c();
      attr(div, "class", "advancement mt-sm svelte-gas-1p18jyw");
...
//# sourceMappingURL=ItemChoice-Cl9rNiwF.js.map
