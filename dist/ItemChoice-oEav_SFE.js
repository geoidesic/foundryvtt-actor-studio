import { S as SvelteComponent, i as init, s as safe_not_equal, C as noop, k as detach, x as attr, q as insert, v as element, o as onMount, O as getAdvancementValue, F as set_data, u as append, G as text, B as ensure_array_like, D as destroy_each, w as empty, N as src_url_equal } from "./index-DML2yxOY.js";
...
function create_else_block(ctx) {
  ...
  return {
    c() {
      ...
      attr(div, "class", "flexrow svelte-gas-19fufvb");
      attr(ul, "class", "icon-list svelte-gas-19fufvb");
    },
    m(target, anchor) {
...
function create_if_block(ctx) {
  ...
  return {
    c() {
      ...
      attr(div1, "class", "flexrow svelte-gas-19fufvb");
    },
    m(target, anchor) {
...
function create_then_block(ctx) {
  ...
  return {
    c() {
      ...
      div1 = element("div");
      t = text(t_value);
      attr(img, "class", "icon svelte-gas-19fufvb");
      if (!src_url_equal(img.src, img_src_value = /*item*/
      ctx[5].img)) attr(img, "src", img_src_value);
      attr(img, "alt", img_alt_value = /*item*/
      ctx[5].name);
      attr(div0, "class", "flex0 relative image svelte-gas-19fufvb");
      attr(div1, "class", "flex2 svelte-gas-19fufvb");
      attr(div2, "class", "flexrow svelte-gas-19fufvb");
      attr(li, "class", "left svelte-gas-19fufvb");
    },
    m(target, anchor) {
...
function create_fragment(ctx) {
  ...
  return {
    c() {
      div = element("div");
      if_block.c();
      attr(div, "class", "advancement mt-sm svelte-gas-19fufvb");
...
//# sourceMappingURL=ItemChoice-oEav_SFE.js.map
