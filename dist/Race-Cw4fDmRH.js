...
function create_if_block_4(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      if (dirty[0] & /*type*/
      2048 && t4_value !== (t4_value = /*type*/
      ctx2[11].value ? ", " + /*type*/
      ctx2[11].value : "")) set_data(t4, t4_value);
    },
    d(detaching) {
      if (detaching) {
        detach(ol);
...
function create_each_block_2(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      16384 && t0_value !== (t0_value = /*movement*/
      ctx2[5].label + "")) set_data(t0, t0_value);
      if (dirty[0] & /*filteredMovement*/
      16384 && t2_value !== (t2_value = /*movement*/
...
function create_each_block_1(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      8192 && t0_value !== (t0_value = /*senses*/
      ctx2[4].label + "")) set_data(t0, t0_value);
      if (dirty[0] & /*filteredSenses*/
      8192 && t2_value !== (t2_value = /*senses*/
...
function create_each_block(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      if (dirty[0] & /*advancementComponents, advancementArray*/
      32770 && switch_value !== (switch_value = /*advancementComponents*/
      ctx2[15][
        /*advancement*/
        ctx2[30].type
      ])) {
...
function create_fragment(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      256) iconselect_changes.disabled = /*isDisabled*/
      ctx2[8];
...
function instance($$self, $$props, $$invalidate) {
  ...
  const importAdvancements = async () => {
    for (const advancement of advancementArray) {
      try {
        const module = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../../../molecules/dnd5e/Advancements/AbilityScoreImprovement.svelte": () => import("./AbilityScoreImprovement-k05g35Vo.js"), "../../../molecules/dnd5e/Advancements/Feat.svelte": () => import("./Feat-DqdB2wyX.js"), "../../../molecules/dnd5e/Advancements/HitPoints.svelte": () => import("./HitPoints-CjiSKCBk.js"), "../../../molecules/dnd5e/Advancements/ItemChoice.svelte": () => import("./ItemChoice-COtGA91Y.js"), "../../../molecules/dnd5e/Advancements/ItemGrant.svelte": () => import("./ItemGrant-DhwrlabO.js"), "../../../molecules/dnd5e/Advancements/ScaleValue.svelte": () => import("./ScaleValue-BoymzqtE.js"), "../../../molecules/dnd5e/Advancements/Size.svelte": () => import("./Size-BJCd0-NK.js"), "../../../molecules/dnd5e/Advancements/Subclass.svelte": () => import("./Subclass-DISu7UVe.js"), "../../../molecules/dnd5e/Advancements/Trait.svelte": () => import("./Trait-CxIeC1Gb.js") }), `../../../molecules/dnd5e/Advancements/${advancement.type}.svelte`, 7);
  ...
  const selectHandler = async (option) => {
    ...
    await tick();
    window.GAS.log.d("RACE TAB | After Update:", { value, active, race: $race });
    await importAdvancements();
    $$invalidate(7, richHTML = await illuminatedDescription(html, $race));
  };
  onMount(async () => {
    if ($race) {
  ...
  $$self.$$.update = () => {
    ...
    32) {
      $$invalidate(14, filteredMovement = movement ? Object.keys(movement).filter((key) => key !== "units" && movement[key]).map((key) => ({ label: key, value: movement[key] })) : []);
    }
    if ($$self.$$.dirty[0] & /*senses*/
    16) {
      $$invalidate(13, filteredSenses = senses ? Object.keys(senses).filter((key) => key !== "units" && senses[key]).map((key) => ({ label: key, value: senses[key] })) : []);
    }
    if ($$self.$$.dirty[0] & /*$race*/
    8) {
      $$invalidate(12, units = $race?.system?.movement?.units || "");
    }
    if ($$self.$$.dirty[0] & /*$race*/
    8) {
      $$invalidate(11, type = $race?.system?.type || "");
    }
    if ($$self.$$.dirty[0] & /*$race*/
    8) {
    ...
    4) {
      $$invalidate(10, book = source?.book || "");
    }
    if ($$self.$$.dirty[0] & /*source*/
    4) {
      $$invalidate(9, page = source?.page ? ", p. " + source.page : "");
    }
    if ($$self.$$.dirty[0] & /*$race*/
    8) {
    ...
    1048576) {
      $$invalidate(8, isDisabled = $readOnlyTabs.includes("race"));
    }
  };
...
//# sourceMappingURL=Race-Cw4fDmRH.js.map
