import { S as SvelteComponent, i as init, s as safe_not_equal, e as element, a as empty, b as attr, c as insert, d as append, A as noop, j as detach, z as ensure_array_like, B as destroy_each, F as text, G as set_data } from "./index-CfpApUIi.js";
...
function create_if_block_4(ctx) {
  ...
  return {
    c() {
      div = element("div");
      t = text(t_value);
      attr(div, "class", "flex0 right badge inset svelte-gas-625ulv");
    },
    m(target, anchor) {
...
function create_else_block(ctx) {
  ...
  return {
    c() {
      ...
      attr(div1, "class", "flex0 badge inset right svelte-gas-625ulv");
...
function create_fragment(ctx) {
  ...
  return {
    c() {
      ...
      if (if_block1)
        if_block1.c();
      attr(div, "class", "advancement mt-sm svelte-gas-625ulv");
...
//# sourceMappingURL=Trait-4f5M-Dfm.js.map
