import { S as SvelteComponent, i as init, s as safe_not_equal, d as detach, t as transition_out, a as transition_in, g as group_outros, c as check_outros, b as insert, e as append, f as element, l as localize, h as empty, j as attr, k as component_subscribe, m as abilityGenerationMethod, r as readOnlyTabs, n as getContext, o as onMount, p as getRules, q as tick, u as set_store_value, M as MODULE_ID, v as binding_callbacks, w as bind, x as destroy_component, y as add_flush_callback, z as mount_component, A as create_component, B as ensure_array_like, C as noop, D as destroy_each, E as construct_svelte_component, _ as __variableDynamicImportRuntimeHelper, F as set_data, G as text } from "./index-BZvewgTP.js";
/* empty css                                              */
/* empty css                                                     */
...
function create_else_block(ctx) {
  ...
  return {
    c() {
      ...
      attr(ol, "class", "properties-list svelte-gas-4kpui2");
    },
    m(target, anchor) {
...
function create_if_block(ctx) {
  ...
  return {
    c() {
      ...
      attr(div, "class", "relative svelte-gas-4kpui2");
    },
    m(target, anchor) {
...
function create_if_block_1(ctx) {
  ...
  return {
    c() {
      div = element("div");
      attr(div, "class", "overlay svelte-gas-4kpui2");
    },
    m(target, anchor) {
      insert(target, div, anchor);
    },
...
function create_fragment(ctx) {
  ...
  return {
    c() {
      div4 = element("div");
      h1 = element("h1");
      h1.textContent = `${localize("Tabs.Abilities.Title")}`;
      div3 = element("div");
      div0 = element("div");
      h2 = element("h2");
      ...
      attr(div3, "class", "flexrow svelte-gas-4kpui2");
      attr(div4, "class", "content svelte-gas-4kpui2");
    },
    m(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
  ...
  const importAdvancements = async () => {
    for (const option of options) {
      try {
        const module = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../../../molecules/dnd5e/AbilityEntry/ManualEntry.svelte": () => import("./ManualEntry-BgyVUSvK.js"), "../../../molecules/dnd5e/AbilityEntry/PointBuy.svelte": () => import("./PointBuy-KFik0Z48.js"), "../../../molecules/dnd5e/AbilityEntry/Roll.svelte": () => import("./Roll-PgHnT0Jl.js"), "../../../molecules/dnd5e/AbilityEntry/StandardArray.svelte": () => import("./StandardArray-BXISJ8O0.js") }), `../../../molecules/dnd5e/AbilityEntry/${option.type}.svelte`, 7);
...
//# sourceMappingURL=Abilities-CKKv3Ucj.js.map
