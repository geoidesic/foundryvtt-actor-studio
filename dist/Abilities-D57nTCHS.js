...
function create_fragment(ctx) {
  ...
  return {
    c() {
      div4 = element("div");
      h1 = element("h1");
      h1.textContent = `${localize("GAS.Tabs.Abilities.Title")}`;
      div3 = element("div");
      div0 = element("div");
      h2 = element("h2");
      h2.textContent = `${localize("GAS.Tabs.Abilities.HowCalculated")}`;
      if_block0.c();
...
function instance($$self, $$props, $$invalidate) {
  ...
  const importAdvancements = async () => {
    for (const option of options) {
      try {
        const module = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../../../molecules/dnd5e/AbilityEntry/ManualEntry.svelte": () => import("./ManualEntry-BkJdsubj.js"), "../../../molecules/dnd5e/AbilityEntry/PointBuy.svelte": () => import("./PointBuy-_BTzfDAl.js"), "../../../molecules/dnd5e/AbilityEntry/Roll.svelte": () => import("./Roll-CYP05VE6.js"), "../../../molecules/dnd5e/AbilityEntry/StandardArray.svelte": () => import("./StandardArray-Dgvk8N0n.js") }), `../../../molecules/dnd5e/AbilityEntry/${option.type}.svelte`, 7);
  ...
  let rules = "", active, placeHolder = localize("GAS.Tabs.Abilities.AbilityGenerationMethod");
  onMount(async () => {
...
//# sourceMappingURL=Abilities-D57nTCHS.js.map
