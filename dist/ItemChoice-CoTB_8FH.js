import { S as SvelteComponent, i as init, s as safe_not_equal, e as element, b as attr, c as insert, A as noop, j as detach, o as onMount, z as ensure_array_like, F as text, d as append, G as set_data, B as destroy_each, a as empty, L as src_url_equal } from "./index-CfpApUIi.js";
import { h as handle_promise, u as update_await_block_branch } from "./await_block-D4WZxI2z.js";
...
function create_else_block(ctx) {
  ...
  return {
    c() {
      ...
      attr(div, "class", "flexrow svelte-gas-184l2d6");
...
function create_if_block(ctx) {
  ...
  return {
    c() {
      ...
      attr(div1, "class", "flexrow svelte-gas-184l2d6");
    },
    m(target, anchor) {
...
function create_then_block(ctx) {
  ...
  return {
    c() {
      ...
      attr(div2, "class", "flexrow svelte-gas-184l2d6");
      attr(li, "class", "left");
    },
    m(target, anchor) {
...
function create_fragment(ctx) {
  ...
  return {
    c() {
      div = element("div");
      if_block.c();
      attr(div, "class", "advancement mt-sm svelte-gas-184l2d6");
...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    if ("advancement" in $$props2)
      $$invalidate(0, advancement = $$props2.advancement);
  };
  $$self.$$.update = () => {
...
//# sourceMappingURL=ItemChoice-CoTB_8FH.js.map
