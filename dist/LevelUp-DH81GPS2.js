...
function instance$1($$self, $$props, $$invalidate) {
  ...
  const importClassAdvancements = async () => {
    for (const classAdvancement of classAdvancementArrayFiltered) {
      try {
        const module = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../../components/molecules/dnd5e/Advancements/AbilityScoreImprovement.svelte": () => import("./AbilityScoreImprovement-BzCFH4sy.js"), "../../components/molecules/dnd5e/Advancements/Feat.svelte": () => import("./Feat-BLPyQ970.js"), "../../components/molecules/dnd5e/Advancements/HitPoints.svelte": () => import("./HitPoints-BpUWaGWw.js"), "../../components/molecules/dnd5e/Advancements/ItemChoice.svelte": () => import("./ItemChoice-CmvFM45S.js"), "../../components/molecules/dnd5e/Advancements/ItemGrant.svelte": () => import("./ItemGrant-Dj9gCp9p.js"), "../../components/molecules/dnd5e/Advancements/ScaleValue.svelte": () => import("./ScaleValue-DxuahsBe.js"), "../../components/molecules/dnd5e/Advancements/Size.svelte": () => import("./Size-CZXiOL5Q.js"), "../../components/molecules/dnd5e/Advancements/Subclass.svelte": () => import("./Subclass-D606EiQN.js"), "../../components/molecules/dnd5e/Advancements/Trait.svelte": () => import("./Trait-txKhZT8E.js") }), `../../components/molecules/dnd5e/Advancements/${classAdvancement.type}.svelte`, 7);
...
function create_if_block_9(ctx) {
  ...
  let t_value = (
    /*$isLevelUpAdvancementInProgress*/
    (ctx[15] ? localize("GAS.LevelUp.DisabledDescription") : localize("GAS.LevelUp.CancelDescription")) + ""
  );
  let t;
  return {
    c() {
    ...
    p(ctx2, dirty) {
      ...
      32768 && t_value !== (t_value = /*$isLevelUpAdvancementInProgress*/
      (ctx2[15] ? localize("GAS.LevelUp.DisabledDescription") : localize("GAS.LevelUp.CancelDescription")) + "")) set_data(t, t_value);
    },
    d(detaching) {
      if (detaching) {
        detach(p);
...
function create_if_block_7(ctx) {
  ...
  classlevelrow = new ClassLevelRow({
    props: {
      cssClasses: (
        /*decorators*/
        ctx[20].existingClassesCssClassForRow(
          /*classKey*/
          ctx[45]
        )
      ),
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      1) classlevelrow_changes.cssClasses = /*decorators*/
      ctx2[20].existingClassesCssClassForRow(
        /*classKey*/
        ctx2[45]
      );
      if (dirty[0] & /*classKeys*/
      1) classlevelrow_changes.eventHandler = /*eventHandlers*/
      ctx2[22].handleRowDeactivation(
        /*classKey*/
        ctx2[45]
      );
      if (dirty[0] & /*classKeys*/
      1) classlevelrow_changes.imgSrc = /*getters*/
      ctx2[21].getCharacterClass(
        /*classKey*/
        ctx2[45]
      )?.img;
      ...
      if (dirty[0] & /*classKeys*/
      1) classlevelrow_changes.classKey = /*classKey*/
      ctx2[45];
      if (dirty[0] & /*$newLevelValueForExistingClass*/
      4) classlevelrow_changes.newLevel = /*$newLevelValueForExistingClass*/
      ctx2[2];
      if (dirty[0] & /*classKeys*/
      1) classlevelrow_changes.tooltip = /*getters*/
      ctx2[21].rowTooltip(
        /*classKey*/
        ctx2[45]
      );
      if (dirty[0] & /*$isLevelUpAdvancementInProgress*/
      32768) classlevelrow_changes.disabled = /*$isLevelUpAdvancementInProgress*/
      ctx2[15];
...
function create_if_block_8(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      if (dirty[0] & /*$classUuidForLevelUp*/
      2) classlevelrow_changes.iconClass = /*$classUuidForLevelUp*/
      ctx2[1] ? "" : "fas fa-plus";
      classlevelrow.$set(classlevelrow_changes);
    },
    i(local) {
...
function create_if_block_4(ctx) {
  ...
  let iconselect_props = {
    ...
    handler: (
      /*eventHandlers*/
      ctx[22].selectMultiClassHandler
    ),
...
function create_if_block_1(ctx) {
  ...
  let if_block0 = (
    ...
    ctx[16] && (window.GAS.dnd5eVersion < 4 || window.GAS.dnd5eRules == "2014") && create_if_block_3()
  );
  let if_block1 = (
    /*$isLevelUpAdvancementInProgress*/
    (ctx[15] || /*subclasses*/
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      ctx2[7];
      if (dirty[0] & /*$newLevelValueForExistingClass*/
      4) leftcoldetails_changes.level = /*$newLevelValueForExistingClass*/
      ctx2[2];
      leftcoldetails.$set(leftcoldetails_changes);
      if (
        /*subclasses*/
        ctx2[8].length && /*$classGetsSubclassThisLevel*/
        ctx2[16] && (window.GAS.dnd5eVersion < 4 || window.GAS.dnd5eRules == "2014")
      ) {
        if (if_block0) ;
        else {
      ...
      if (
        ...
        if (if_block1) {
          ...
          if (dirty[0] & /*$isLevelUpAdvancementInProgress, subclasses, $classGetsSubclassThisLevel*/
          98560) {
...
function create_if_block_2(ctx) {
  ...
  return {
    c() {
      ...
      pre = element("pre");
      t1 = text("classGetsSubclassThisLevel ");
      t2 = text(
    ...
    p(ctx2, dirty) {
      if (!current || dirty[0] & /*$classGetsSubclassThisLevel*/
      65536) set_data(
        t2,
        /*$classGetsSubclassThisLevel*/
        ctx2[16]
      ...
      ctx2[8];
      if (dirty[0] & /*$isLevelUpAdvancementInProgress*/
      32768) iconselect_changes.disabled = /*$isLevelUpAdvancementInProgress*/
      ctx2[15];
...
function create_fragment(ctx) {
  ...
  let html_tag;
  let current;
  let if_block0 = !/*$selectedMultiClassUUID*/
  ctx[4] && create_if_block_6(ctx);
  let if_block1 = !/*$newLevelValueForExistingClass*/
  ...
  return {
    c() {
      ...
      pre10 = element("pre");
      t20 = text("classGetsSubclassThisLevel ");
      t21 = text(
        /*$classGetsSubclassThisLevel*/
        ctx[16]
      );
    ...
    p(ctx2, dirty) {
      if (!current || dirty[0] & /*$classUuidForLevelUp*/
      2) set_data(
        t1,
        /*$classUuidForLevelUp*/
        ctx2[1]
      );
      if (!current || dirty[0] & /*$selectedMultiClassUUID*/
      16) set_data(
        t3,
        /*$selectedMultiClassUUID*/
        ctx2[4]
      );
      if (!current || dirty[0] & /*$isLevelUpAdvancementInProgress*/
      32768) set_data(
        t5,
        /*$isLevelUpAdvancementInProgress*/
        ctx2[15]
      );
      if (!current || dirty[0] & /*$newLevelValueForExistingClass*/
      4) set_data(
        t7,
        /*$newLevelValueForExistingClass*/
        ctx2[2]
      );
      if (!current || dirty[0] & /*$levelUpClassObject*/
      8) set_data(
        t9,
        /*$levelUpClassObject*/
        ctx2[3]
      ...
      if (!current || dirty[0] & /*$levelUpSubClassObject*/
      8192) set_data(
        t13,
        /*$levelUpSubClassObject*/
        ctx2[13]
      );
      if (!current || dirty[0] & /*$subClassUuidForLevelUp*/
      32) set_data(
        t15,
        /*$subClassUuidForLevelUp*/
        ctx2[5]
      );
      if (!current || dirty[0] & /*$activeRowClassKey*/
      16384) set_data(
        t17,
        /*$activeRowClassKey*/
        ctx2[14]
...
function instance($$self, $$props, $$invalidate) {
  ...
  component_subscribe($$self, levelUpPreAdvancementSelections, ($$value) => $$invalidate(36, $levelUpPreAdvancementSelections = $$value));
  component_subscribe($$self, classUuidForLevelUp, ($$value) => $$invalidate(1, $classUuidForLevelUp = $$value));
  component_subscribe($$self, newLevelValueForExistingClass, ($$value) => $$invalidate(2, $newLevelValueForExistingClass = $$value));
  ...
  component_subscribe($$self, levelUpRichHTML, ($$value) => $$invalidate(26, $levelUpRichHTML = $$value));
  component_subscribe($$self, selectedMultiClassUUID, ($$value) => $$invalidate(4, $selectedMultiClassUUID = $$value));
  component_subscribe($$self, subClassUuidForLevelUp, ($$value) => $$invalidate(5, $subClassUuidForLevelUp = $$value));
  component_subscribe($$self, levelUpSubClassObject, ($$value) => $$invalidate(13, $levelUpSubClassObject = $$value));
  component_subscribe($$self, activeRowClassKey, ($$value) => $$invalidate(14, $activeRowClassKey = $$value));
  component_subscribe($$self, isNewMultiClassSelected, ($$value) => $$invalidate(37, $isNewMultiClassSelected = $$value));
  component_subscribe($$self, isLevelUpAdvancementInProgress, ($$value) => $$invalidate(15, $isLevelUpAdvancementInProgress = $$value));
  component_subscribe($$self, classGetsSubclassThisLevel, ($$value) => $$invalidate(16, $classGetsSubclassThisLevel = $$value));
  ...
  component_subscribe($$self, actor, (value) => $$invalidate(25, $actor = value));
  const decorators = {
  ...
  const importers = {
    async importClassAdvancements() {
      ...
      for (const classAdvancement of classAdvancementArrayFiltered) {
        try {
          const module = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../../../molecules/dnd5e/Advancements/AbilityScoreImprovement.svelte": () => import("./AbilityScoreImprovement-BzCFH4sy.js"), "../../../molecules/dnd5e/Advancements/Feat.svelte": () => import("./Feat-BLPyQ970.js"), "../../../molecules/dnd5e/Advancements/HitPoints.svelte": () => import("./HitPoints-BpUWaGWw.js"), "../../../molecules/dnd5e/Advancements/ItemChoice.svelte": () => import("./ItemChoice-CmvFM45S.js"), "../../../molecules/dnd5e/Advancements/ItemGrant.svelte": () => import("./ItemGrant-Dj9gCp9p.js"), "../../../molecules/dnd5e/Advancements/ScaleValue.svelte": () => import("./ScaleValue-DxuahsBe.js"), "../../../molecules/dnd5e/Advancements/Size.svelte": () => import("./Size-CZXiOL5Q.js"), "../../../molecules/dnd5e/Advancements/Subclass.svelte": () => import("./Subclass-D606EiQN.js"), "../../../molecules/dnd5e/Advancements/Trait.svelte": () => import("./Trait-txKhZT8E.js") }), `../../../molecules/dnd5e/Advancements/${classAdvancement.type}.svelte`, 7);
    ...
    async importSubClassAdvancements() {
      ...
      for (const subClassAdvancement of subClassAdvancementArrayFiltered) {
        try {
          const module = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../../../molecules/dnd5e/Advancements/AbilityScoreImprovement.svelte": () => import("./AbilityScoreImprovement-BzCFH4sy.js"), "../../../molecules/dnd5e/Advancements/Feat.svelte": () => import("./Feat-BLPyQ970.js"), "../../../molecules/dnd5e/Advancements/HitPoints.svelte": () => import("./HitPoints-BpUWaGWw.js"), "../../../molecules/dnd5e/Advancements/ItemChoice.svelte": () => import("./ItemChoice-CmvFM45S.js"), "../../../molecules/dnd5e/Advancements/ItemGrant.svelte": () => import("./ItemGrant-Dj9gCp9p.js"), "../../../molecules/dnd5e/Advancements/ScaleValue.svelte": () => import("./ScaleValue-DxuahsBe.js"), "../../../molecules/dnd5e/Advancements/Size.svelte": () => import("./Size-CZXiOL5Q.js"), "../../../molecules/dnd5e/Advancements/Subclass.svelte": () => import("./Subclass-D606EiQN.js"), "../../../molecules/dnd5e/Advancements/Trait.svelte": () => import("./Trait-txKhZT8E.js") }), `../../../molecules/dnd5e/Advancements/${subClassAdvancement.type}.svelte`, 7);
          await tick();
  ...
  const eventHandlers = {
    ...
    */
    clickAddLevel: async (classKey) => {
      ...
      $$invalidate(24, richSubClassHTML = "");
      ...
      await tick();
      $$invalidate(23, subClassesIndex = await filters.getFilteredSubclassIndex());
      await tick();
    ...
    */
    selectSubClassHandler: async (option) => {
      ...
      $$invalidate(24, richSubClassHTML = await illuminatedDescription($levelUpSubClassObject?.system?.description?.value, $levelUpSubClassObject));
  ...
  $$self.$$.update = () => {
    ...
    if ($$self.$$.dirty[0] & /*$levelUpClassObject, $newLevelValueForExistingClass*/
    12) {
      if ($levelUpClassObject?.system?.advancement.length) {
        $$invalidate(7, classAdvancementArrayFiltered = $levelUpClassObject?.advancement?.byLevel[$newLevelValueForExistingClass]);
      } else {
...
//# sourceMappingURL=LevelUp-DH81GPS2.js.map
