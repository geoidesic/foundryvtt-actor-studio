import { S as SvelteComponent, i as init, s as safe_not_equal, l as localize, d as destroy_component, t as transition_out, a as transition_in, m as mount_component, c as create_component, b as component_subscribe, e as abilityGenerationMethod, r as readOnlyTabs, g as getContext, o as onMount, f as getRules, h as tick, j as set_store_value, M as MODULE_ID, k as detach, n as group_outros, p as check_outros, q as insert, u as append, v as element, w as empty, x as attr, _ as __variableDynamicImportRuntimeHelper, y as binding_callbacks, z as bind, A as add_flush_callback, B as ensure_array_like, C as noop, D as destroy_each, E as construct_svelte_component, F as set_data, G as text } from "./index-DTKvterJ.js";
/* empty css                                              */
/* empty css                                                     */
import { I as IconSelect } from "./IconSelect-Ce5djQUw.js";
import { S as StandardTabLayout } from "./StandardTabLayout-XKDyt8oh.js";
...
function create_each_block(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      ctx2[18].label + "")) set_data(t_1, t_1_value);
    },
    d(detaching) {
      if (detaching) {
        detach(li);
...
function create_if_block(ctx) {
  ...
  return {
    c() {
      ...
      attr(div, "class", "relative svelte-gas-7zvale");
    },
    m(target, anchor) {
...
function create_if_block_1(ctx) {
  ...
  return {
    c() {
      div = element("div");
      attr(div, "class", "overlay svelte-gas-7zvale");
    },
    m(target, anchor) {
      insert(target, div, anchor);
    },
...
function create_left_slot(ctx) {
  ...
  return {
    c() {
      div = element("div");
      h2 = element("h2");
      h2.textContent = `${localize("Tabs.Abilities.HowCalculated")}`;
      if_block0.c();
...
function create_fragment(ctx) {
  ...
  standardtablayout = new StandardTabLayout({
    props: {
      title: localize("Tabs.Abilities.Title"),
      showTitle: true,
      tabName: "abilities",
      $$slots: {
  ...
  return {
    ...
    p(ctx2, [dirty]) {
      ...
      if (dirty & /*$$scope, richHTML, isDisabled, abilityModule, $abilityGenerationMethod, options, active*/
      2097215) {
...
function instance($$self, $$props, $$invalidate) {
  ...
  const importAdvancements = async () => {
    for (const option of options) {
      try {
        const module = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../../../molecules/dnd5e/AbilityEntry/ManualEntry.svelte": () => import("./ManualEntry-MVdxoOZ2.js"), "../../../molecules/dnd5e/AbilityEntry/PointBuy.svelte": () => import("./PointBuy-BUKUncsZ.js"), "../../../molecules/dnd5e/AbilityEntry/Roll.svelte": () => import("./Roll-CvAqL1X2.js"), "../../../molecules/dnd5e/AbilityEntry/StandardArray.svelte": () => import("./StandardArray-dd2shMG8.js") }), `../../../molecules/dnd5e/AbilityEntry/${option.type}.svelte`, 7);
  ...
  let rules = "", active, placeHolder = localize("Tabs.Abilities.AbilityGenerationMethod");
  onMount(async () => {
...
//# sourceMappingURL=Abilities-DicYZZ2F.js.map
