import { S as SvelteComponent, i as init, s as safe_not_equal, C as binding_callbacks, D as bind, e as element, F as text, v as create_component, b as attr, c as insert, d as append, w as mount_component, E as add_flush_callback, h as transition_in, g as group_outros, t as transition_out, f as check_outros, j as detach, x as destroy_component, k as component_subscribe, as as race, r as readOnlyTabs, J as getPacksFromSettings, K as extractItemsFromPacksSync, M as MODULE_ID, n as getContext, o as onMount, a as empty, W as space, G as set_data, z as ensure_array_like, l as localize, B as destroy_each, u as construct_svelte_component, L as src_url_equal, N as getAdvancementValue, y as set_store_value, O as illuminatedDescription, _ as __variableDynamicImportRuntimeHelper } from "./index-BVq7xSxh.js";
import { I as IconSelect } from "./IconSelect-CBKJKP4T.js";
...
function create_each_block_2(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      512 && t0_value !== (t0_value = /*movement*/
      ctx2[4].label + "")) set_data(t0, t0_value);
      if (dirty[0] & /*filteredMovement*/
      512 && t2_value !== (t2_value = /*movement*/
...
function create_each_block_1(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      256 && t0_value !== (t0_value = /*senses*/
      ctx2[3].label + "")) set_data(t0, t0_value);
      if (dirty[0] & /*filteredSenses*/
      256 && t2_value !== (t2_value = /*senses*/
...
function create_each_block(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      if (dirty[0] & /*advancementComponents, advancementArray*/
      32896 && switch_value !== (switch_value = /*advancementComponents*/
      ctx2[15][
        /*advancement*/
        ctx2[30].type
      ])) {
...
function create_fragment(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      4 && div0_class_value !== (div0_class_value = "flex0 required " + /*$race*/
      (ctx2[2] ? "" : "active"))) {
      ...
      ctx2[16];
      if (dirty[0] & /*active*/
      32) iconselect_changes.active = /*active*/
      ctx2[5];
      if (dirty[0] & /*isDisabled*/
      1024) iconselect_changes.disabled = /*isDisabled*/
      ctx2[10];
...
function instance($$self, $$props, $$invalidate) {
  ...
  let $readOnlyTabs;
  let $actor;
  component_subscribe($$self, race, ($$value) => $$invalidate(2, $race = $$value));
  ...
  async function importAdvancements() {
    for (const advancement of advancementArray) {
      try {
        const module = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../../../molecules/dnd5e/Advancements/AbilityScoreImprovement.svelte": () => import("./AbilityScoreImprovement-CdHjjDEI.js"), "../../../molecules/dnd5e/Advancements/Feat.svelte": () => import("./Feat-BWVQyflu.js"), "../../../molecules/dnd5e/Advancements/HitPoints.svelte": () => import("./HitPoints-3DvCH8Rf.js"), "../../../molecules/dnd5e/Advancements/ItemChoice.svelte": () => import("./ItemChoice-Caa0biAW.js"), "../../../molecules/dnd5e/Advancements/ItemGrant.svelte": () => import("./ItemGrant-BeWV_8GA.js"), "../../../molecules/dnd5e/Advancements/ScaleValue.svelte": () => import("./ScaleValue-ZNU7qY5E.js"), "../../../molecules/dnd5e/Advancements/Size.svelte": () => import("./Size-DROyhqGQ.js"), "../../../molecules/dnd5e/Advancements/Subclass.svelte": () => import("./Subclass-CXIFoXxQ.js"), "../../../molecules/dnd5e/Advancements/Trait.svelte": () => import("./Trait-Bfc9GmpA.js") }), `../../../molecules/dnd5e/Advancements/${advancement.type}.svelte`, 7);
        $$invalidate(15, advancementComponents[advancement.type] = module.default, advancementComponents);
      } catch (error) {
  ...
  async function selectRaceHandler(option) {
    ...
    $$invalidate(5, active = option);
    if (!value) {
      $$invalidate(0, value = option);
    }
    await importAdvancements();
    $$invalidate(6, richHTML = await illuminatedDescription(html, $race));
  }
  onMount(async () => {
    let raceUuid;
    if (window.GAS.debug) {
  ...
  $$self.$$.update = () => {
    ...
    if ($$self.$$.dirty[0] & /*$race*/
    4) {
      $$invalidate(4, movement = $race?.system?.movement);
    }
    if ($$self.$$.dirty[0] & /*$race*/
    4) {
      $$invalidate(3, senses = $race?.system?.senses);
    }
    if ($$self.$$.dirty[0] & /*$race*/
    4) {
    ...
    1048576) {
      $$invalidate(10, isDisabled = $readOnlyTabs.includes("race"));
    }
    if ($$self.$$.dirty[0] & /*movement*/
    16) {
      $$invalidate(9, filteredMovement = movement ? Object.keys(movement).filter((key) => key !== "units" && movement[key]).map((key) => ({ label: key, value: movement[key] })) : []);
    }
    if ($$self.$$.dirty[0] & /*senses*/
    8) {
      $$invalidate(8, filteredSenses = senses ? Object.keys(senses).filter((key) => key !== "units" && senses[key]).map((key) => ({ label: key, value: senses[key] })) : []);
    }
    if ($$self.$$.dirty[0] & /*$race*/
    4) {
      $$invalidate(7, advancementArray = $race?.system?.advancement ? $race.system.advancement.filter((value2) => !(value2.type == "Trait" && value2.title == "Dwarven Resilience")) : []);
    }
  };
  $$invalidate(16, options = raceDefinitions);
  $$invalidate(15, advancementComponents = {});
  return [
    value,
    source,
    $race,
...
//# sourceMappingURL=Race-BZ5wPa1R.js.map
