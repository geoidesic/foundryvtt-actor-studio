import { S as SvelteComponent, i as init, s as safe_not_equal, e as element, b as attr, c as insert, A as noop, j as detach, o as onMount, z as ensure_array_like, F as text, d as append, G as set_data, B as destroy_each, V as getAdvancementHint, a as empty, K as src_url_equal } from "./index-C3npTqsA.js";
import { h as handle_promise, u as update_await_block_branch } from "./await_block-YfmdGV6U.js";
...
function create_if_block(ctx) {
  let div1;
  let div0;
  let t_value = getAdvancementHint(
    /*advancement*/
    ctx[0]
  ) + "";
  let t;
  return {
    ...
    p(ctx2, dirty) {
      ...
      1 && t_value !== (t_value = getAdvancementHint(
        /*advancement*/
        ctx2[0]
      ) + "")) set_data(t, t_value);
    },
...
//# sourceMappingURL=ItemChoice-B8--Zxz-.js.map
