import { S as SvelteComponent, i as init, s as safe_not_equal, C as binding_callbacks, D as bind, e as element, F as text, u as create_component, b as attr, c as insert, d as append, v as mount_component, E as add_flush_callback, h as transition_in, g as group_outros, t as transition_out, f as check_outros, j as detach, w as destroy_component, k as component_subscribe, $ as race, I as getPacksFromSettings, J as extractItemsFromPacks, n as getContext, o as onMount, q as tick, a as empty, Q as space, G as set_data, z as ensure_array_like, l as localize, B as destroy_each, r as construct_svelte_component, K as src_url_equal, _ as __variableDynamicImportRuntimeHelper, x as log, y as set_store_value } from "./index-BrHliVqV.js";
import { I as IconSelect } from "./IconSelect-BPHFv5Vk.js";
...
function create_each_block(ctx) {
  ...
  return {
    c() {
      ...
      ctx[27].configuration?.hint || null);
    ...
    p(ctx2, dirty) {
      ...
      ctx2[27].configuration?.hint || null)) {
        attr(div2, "data-tooltip", div2_data_tooltip_value);
      }
      if (dirty[0] & /*advancementComponents, advancementArray*/
      16512 && switch_value !== (switch_value = /*advancementComponents*/
      ctx2[14][
        /*advancement*/
        ctx2[27].type
      ])) {
...
function instance($$self, $$props, $$invalidate) {
  ...
  const importAdvancements = async () => {
    for (const advancement of advancementArray) {
      try {
        const module = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../../../molecules/dnd5e/Advancements/AbilityScoreImprovement.svelte": () => import("./AbilityScoreImprovement-B_51Yx7P.js"), "../../../molecules/dnd5e/Advancements/Feat.svelte": () => import("./Feat-kCINIycv.js"), "../../../molecules/dnd5e/Advancements/ItemChoice.svelte": () => import("./ItemChoice-CuDRmVbH.js"), "../../../molecules/dnd5e/Advancements/ItemGrant.svelte": () => import("./ItemGrant-DwcRnVyf.js"), "../../../molecules/dnd5e/Advancements/ScaleValue.svelte": () => import("./ScaleValue-CdTvAU3b.js"), "../../../molecules/dnd5e/Advancements/Size.svelte": () => import("./Size-evuE1clo.js"), "../../../molecules/dnd5e/Advancements/Trait.svelte": () => import("./Trait-4J-K9r4v.js") }), `../../../molecules/dnd5e/Advancements/${advancement.type}.svelte`, 7);
  ...
  const selectHandler = async (option) => {
    ...
    $$invalidate(6, richHTML = await TextEditor.enrichHTML(html));
  };
  onMount(async () => {
    if ($race) {
  ...
  $$self.$$.update = () => {
    ...
    if ($$self.$$.dirty[0] & /*$race*/
    4) {
      $$invalidate(7, advancementArray = $race?.advancement?.byId ? Object.entries($race.advancement.byId).map(([id, value2]) => ({ ...value2, id })).filter((value2) => !(value2.type == "Trait" && value2.title == "Dwarven Resilience")) : (
...
//# sourceMappingURL=Race-C2ItpnYE.js.map
