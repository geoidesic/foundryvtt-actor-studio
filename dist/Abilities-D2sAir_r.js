...
function create_else_block(ctx) {
  ...
  return {
    c() {
      ...
      attr(ol, "class", "properties-list svelte-gas-1igv0dg");
    },
    m(target, anchor) {
...
function create_if_block(ctx) {
  ...
  return {
    c() {
      ...
      attr(div, "class", "relative svelte-gas-1igv0dg");
    },
    m(target, anchor) {
...
function create_if_block_1(ctx) {
  ...
  return {
    c() {
      div = element("div");
      attr(div, "class", "overlay svelte-gas-1igv0dg");
    },
    m(target, anchor) {
      insert(target, div, anchor);
    },
...
function create_fragment(ctx) {
  ...
  return {
    c() {
      ...
      attr(div3, "class", "flexrow svelte-gas-1igv0dg");
      attr(div4, "class", "content svelte-gas-1igv0dg");
    },
    m(target, anchor) {
...
//# sourceMappingURL=Abilities-D2sAir_r.js.map
