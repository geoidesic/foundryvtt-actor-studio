...
export function createWorkflowStateMachine() {
  const fsm = Finity
    ...
    .onEnter((context) => {
      if (workflowFSMContext.isProcessing) workflowFSMContext.isProcessing.set(false);
      window.GAS.log.e('[WORKFLOW] Error entered ERROR state:', context.error);
...
// import { workflowFSMContext } from '~/src/helpers/PC/WorkflowStateMachine';
// import { createWorkflowStateMachine, WORKFLOW_EVENTS } from '~/src/helpers/PC/WorkflowStateMachine';
