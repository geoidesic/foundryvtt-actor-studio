<script>
  ...
  import { getEquipmentIcon, getEquipmentItemClasses, getOptionClasses, handleSelection, isGroupEditable, isGroupFromSource, matchingGroupsForSource } from "~/src/stores/equipmentSelections";
