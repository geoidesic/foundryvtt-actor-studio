<script>
  ...
  import { extractMapIteratorObjectProperties, getPackFolders,
    getPacksFromSettings, log, getRules } from "~/src/helpers/Utility";
...
<div class="spells-tab-container" class:disabled={isDisabled}>
  <div class="spells-tab">
    ...
    <div class="left-panel">
      ...
      <h3 class="left no-margin">{t('Spells.MaxSpellLevel')}: {$maxSpellLevel}</h3>
